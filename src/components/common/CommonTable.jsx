...
//         // Set the example data to the products state
...
//                     id: i,
//                     name: `Product ${i + 1}`,
//                     country: { name: `Country ${i}`, code: `C${i}` },
//                     representative: representatives[i % representatives.length],
...
//         const exampleProducts = generateDummyData();
//         setCustomers(exampleProducts);
//         setLoading(false);
//     }, [])
