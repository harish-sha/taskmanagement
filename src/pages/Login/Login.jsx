...
const Login = () => {
    ...
    return (
        <div className="h-screen w-full flex items-center justify-center bg-[#7f9ac8] relative ">
            <div className="w-100 absolute left-20  -bottom-5 ">
                <Lottie
                    autoplay
                    loop
                    animationData={boxAnimation}
            ...
            <div className="flex items-center justify-center z-50 w-fit  rounded-2xl  ">
                <div className="flex justify-center items-center">
                    <div className="max-w-4xl h-[75vh] rounded-4xl shadow-xl grid grid-cols-2 overflow-hidden bg-gradient-to-br from-[#3a4faf] to-[#4283cf]  ">
                        <div className="flex justify-center items-center">
                            <div className="p-8 w-150 popf">
                                <>
                                    <form className="flex flex-col space-y-3  justify-center popf mt-2">
            ...
            <div className="w-100 absolute right-20 -top-5">
                <Lottie
                    autoplay
                    loop
                    animationData={boxAnimation}
